...
var RbdInvariant = function (_Error) {
  _inheritsLoose__default["default"](RbdInvariant, _Error);
...
var isPartiallyVisible = function isPartiallyVisible(args) {
  return isVisible$1(_extends__default["default"]({}, args, {
...
var publishWhileDraggingInVirtual = (function (_ref) {
  ...
  var draggingState = _extends__default["default"]({}, state, {
    phase: 'DRAGGING',
    impact: impact,
  ...
  var dropPending = _extends__default["default"]({}, draggingState, {
    phase: 'DROP_PENDING',
    reason: state.reason,
    isWaiting: false
  });
...
var reducer = (function (state, action) {
  ...
  if (action.type === 'FLUSH') {
    return _extends__default["default"]({}, idle$2, {
      shouldFlush: true
    });
  }
  ...
  if (action.type === 'COLLECTION_STARTING') {
    ...
    var _result = _extends__default["default"]({}, state, {
      phase: 'COLLECTING'
    });
  ...
  if (action.type === 'DROP_PENDING') {
    ...
    var newState = _extends__default["default"]({}, state, {
      phase: 'DROP_PENDING',
      isWaiting: true,
      reason: reason
    });
...
var moveTo = function moveTo(offset) {
  return isEqual$1(offset, origin) ? undefined : "translate(" + offset.x + "px, " + offset.y + "px)";
};
...
function useSensorMarshal(_ref4) {
  ...
  var isLockClaimed = useMemoOne.useCallback(function () {
...
var Droppable = function Droppable(props) {
  ...
  var placeholder = useMemoOne.useMemo(function () {
